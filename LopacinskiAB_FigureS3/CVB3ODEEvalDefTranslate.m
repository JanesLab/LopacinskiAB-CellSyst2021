function [MedianSolutions,MeanSolutions,UpperQuantileSolutions,LowerQuantileSolutions,SensitivitySolutions] = CVB3ODEEvalDefTranslate(MOI,varargin)
...
[t,SolutionsMatrix] = ode15s(@(t,y)CVB3ODEfuncDefTranslate(t,y,Constants,IFNSwitch,VirResponse,IFNStimulation,IFNStimulationTime),TSPAN,InitVals,Options); %Solving the ODE
