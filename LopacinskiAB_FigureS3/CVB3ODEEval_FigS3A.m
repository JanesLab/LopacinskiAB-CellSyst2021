function [MedianSolutions,MeanSolutions,UpperQuantileSolutions,LowerQuantileSolutions,SensitivitySolutions,VPminimum] = CVB3ODEEval_FigS3A(MOI,varargin)
...
%%%Enable user-defined polysome size
    %PolysomeSize:  The number of polysomes in translation complexes.  Default = 2.5.
%%%
%
%OUTPUTS:
...
%%%Enable user-defined polysome size
   addOptional(CVB3ODEEvalparser,'PolysomeSize',defaultPolysomeSize,validPosNum);   
%%%
...
%%%Enable user-defined polysome size
PolysomeSize = CVB3ODEEvalparser.Results.PolysomeSize;
%%%
...
%%%Find the viral protein minimum indicating the start of productive translation
for i=1:size(TotalP1,2) %Look for minimum time of viral protein, ignoring delivery
    VPminimum(i) = t([false(24,1); TotalP1(25:size(TotalP1,1),i) == ...
        min(TotalP1(25:size(TotalP1,1),i))]);
end
VPminimum=VPminimum';
%%%
