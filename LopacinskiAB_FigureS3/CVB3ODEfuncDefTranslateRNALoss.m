function [dCdt] = CVB3ODEfuncDefTranslateRNALoss( t,InitVals,Constants,IFNSwitch,VirResponse,IFNStimulation,IFNStimulationTime )
...
dCdt = [DAFdiss - DAFform; %uCVB3
    ...
    RNARelease_Defect - TranslateForm_Defect - PosCytDefectDeg; %R_p_cyt_Defective
