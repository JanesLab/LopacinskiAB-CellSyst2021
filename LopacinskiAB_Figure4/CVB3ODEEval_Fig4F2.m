function [MedianSolutions,MeanSolutions,UpperQuantileSolutions,LowerQuantileSolutions,SensitivitySolutions] = CVB3ODEEval_Fig4F2(MOI,varargin)
...
%**************************************************************************
%Decreased 10-fold from base model value (36 h^-1)
k_Pentamer_off = lognrnd(muFunc(3.6,(CV*3.6)^2),sigma); %(h^-1) 
%**************************************************************************
