function [MedianSolutions,MeanSolutions,UpperQuantileSolutions,LowerQuantileSolutions,SensitivitySolutions] = CVB3ODEEval_Fig4H(MOI,varargin)
...
%**************************************************************************
%Increased 10-fold from base model value (1 h^-1)
k_P_on = lognrnd(muFunc(10,(CV*10)^2),sigma); %(h^-1) 
k_P_off = lognrnd(muFunc(10,(CV*10)^2),sigma); %(h^-1) 
k_N_on = lognrnd(muFunc(10,(CV*10)^2),sigma); %(h^-1) 
k_N_off = lognrnd(muFunc(10,(CV*10)^2),sigma); %(h^-1) 
%**************************************************************************
