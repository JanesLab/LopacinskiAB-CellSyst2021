function [MedianSolutions,MeanSolutions,UpperQuantileSolutions,LowerQuantileSolutions,SensitivitySolutions] = CVB3ODEEval_Fig4F1(MOI,varargin)
...
%**************************************************************************
%Increased 10-fold from base model value (36 h^-1)
k_Pentamer_off = lognrnd(muFunc(360,(CV*360)^2),sigma); %(h^-1) 
%**************************************************************************
