function [MedianSolutions,MeanSolutions,UpperQuantileSolutions,LowerQuantileSolutions,SensitivitySolutions] = CVB3ODEEval_Fig4G(MOI,varargin)
...
%**************************************************************************
%Decreased 10-fold from base model value (1 h^-1)
k_P_off = lognrnd(muFunc(0.1,(CV*0.1)^2),sigma); %(h^-1) 
%**************************************************************************
...
%**************************************************************************
%Decreased 10-fold from base model value (1 h^-1)
k_N_off = lognrnd(muFunc(0.1,(CV*0.1)^2),sigma); %(h^-1) 
%**************************************************************************
