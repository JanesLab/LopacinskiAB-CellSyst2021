function [MedianSolutions,MeanSolutions,UpperQuantileSolutions,LowerQuantileSolutions,SensitivitySolutions] = CVB3ODEEval_nodsRNAsens(MOI,varargin)
...
%%%Call alternative CVB3ODEfunc with no dsRNA sensing
[t,SolutionsMatrix] = ode15s(@(t,y)CVB3ODEfunc_nodsRNAsens(t,y,Constants,IFNSwitch,VirResponse,IFNStimulation,IFNStimulationTime),TSPAN,InitVals,Options); %Solving the ODE
%%%
...
if strcmpi(SensitivityAnalysis,'on')
%%%Call alternative CVB3ODEfunc with no dsRNA sensing
    [SensTable]= SensitivityAnalysisfunc(@CVB3ODEfunc_nodsRNAsens,LabeledConstants,LabeledInitVals,SensitivityAnalysisOutput,OtherSpecies,ScalingFactor,MaxScalingOrder,IFNSwitch,VirResponse,IFNStimulation,IFNStimulationTime,MaxTime,Options);
%%%
end
