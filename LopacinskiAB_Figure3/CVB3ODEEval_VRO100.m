function [MedianSolutions,MeanSolutions,UpperQuantileSolutions,LowerQuantileSolutions,SensitivitySolutions] = CVB3ODEEval_VRO100(MOI,varargin)
...
%%%Set VRO concentrating effect to 100
VROVolConv = 100; %CellCytVolume/VROSurfaceVolume; %(dimensionless)
%%%
