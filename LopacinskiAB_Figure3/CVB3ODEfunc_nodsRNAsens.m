function [dCdt] = CVB3ODEfunc_nodsRNAsens( t,InitVals,Constants,IFNSwitch,VirResponse,IFNStimulation,IFNStimulationTime )
...
%%%Set VirDetection to zero to eliminate dsRNA sensing on VROs
    VirDetection = 0; %((TotalDoubleStrands)^n_Hill)/(kD_Hill^n_Hill + (TotalDoubleStrands)^n_Hill); %VirDetection is defined by a Hill equation for detection of dsRNA
%%%
