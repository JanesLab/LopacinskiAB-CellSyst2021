function [MedianSolutions,MeanSolutions,UpperQuantileSolutions,LowerQuantileSolutions,SensitivitySolutions] = CVB3ODEEvalFigS2FG(MOI,varargin)
...
%%%Enable CAR, DAF, and DIP as user-defined inputs
    %CAR: CAR initial condition.  Default = 5.5e6.
    %DAF:  DAF initial condition.  Default = 4.4e4.
    %DIP:  Defective interfering particles.  Default = 800.
%%%
%
%OUTPUTS:
...
%%%Enable CAR, DAF, and DIP as user-defined inputs
   addOptional(CVB3ODEEvalparser,'CAR',defaultCAR,validPosNumOrZero);
   addOptional(CVB3ODEEvalparser,'DAF',defaultDAF,validPosNumOrZero);
   addOptional(CVB3ODEEvalparser,'DIP',defaultDIP,validPosNumOrZero);
%%%
...
DAF_IC = CVB3ODEEvalparser.Results.DAF;
DIP = CVB3ODEEvalparser.Results.DIP;
%%%
...
%%%Enable DIP as user-defined input
ParticlePFUConv = DIP; %Number
%%%
...
%%%Enable DAF as user-defined input
uDAF = DAF_IC / (6.022e23) / (CVB3diameter/1000 * CellSurfaceArea) * 1e24; %(nM) Unbound DAF molecules
%%%
